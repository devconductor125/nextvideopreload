    ...
    <div className="mx-auto max-w-6xl px-4 py-16 lg:px-8 lg:py-20">
      ...
      <div className="mb-0 grid grid-cols-1 items-start gap-2 dark:text-white sm:grid-cols-2 md:my-12 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
        {items.map(({ title, description, icon: Icon, link }, index) => (
          <div
            key={index}
            className="h-90 w-90 m-auto my-4 transform overflow-hidden rounded-lg shadow-lg transition duration-500 ease-in-out hover:-translate-y-2 hover:shadow-2xl md:w-80"
          >
